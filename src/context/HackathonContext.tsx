...
interface HackathonContextType {
  ...
  editHackathon: (id: string, updatedHackathon: Hackathon) => void;
...
export const HackathonProvider = ({ children }: { children: ReactNode }) => {
  ...
  const editHackathon = (id: string, updatedHackathon: Hackathon) => {
  ...
  return (
    <HackathonContext.Provider value={{ hackathons, setHackathons, addHackathon, deleteHackathon, editHackathon, getHackathonById }}>
      {children}
